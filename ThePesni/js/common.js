$(function() {
	...
	// function hideNavBar() {
	//   var scrollTop = $('.song-scrollbar-wrapper').scrollTop();
	//   var navBar = $('.header__top');
	//   var wrapper = $('.song-scrollbar-wrapper');

	// 	navBar.css("opacity", 1 - (scrollTop / 70));
	...
	function hideNavBar() {
	  ...
	  var wrapper = $('.song-scrollbar-wrapper');
		...
		navBar.css({"transform": "translate3d(0px, " + (0 - scrollTop) + "px, 0px)"});
		wrapper.css({"transform": "translate3d(0px, " + (0 - scrollTop) + "px, 0px)"});
	  if (scrollTop >= 67) {
	  	navBar.css({"transform": "translate3d(0px, " + (-67) + "px, 0px)"});
			wrapper.css({"transform": "translate3d(0px, " + (-67) + "px, 0px)"});
	  }
	}

	$('.song-scrollbar-wrapper').scroll(function(){
		hideNavBar();
	});
	...
	if (isMobile){
		$('.song-scrollbar-wrapper').css("margin-right", 0);
	}
